...
FOLDER_ID = '1knc42Kvhoae2Ut7OAzx4283uRp0ct1AL'
SCOPES = ['https://www.googleapis.com/auth/drive']
PREFIX = 'UPP'
SCRIPTS = tuple(f"{PREFIX}{n}" for n in range(1, 8))
...
def main():
    parser = argparse.ArgumentParser(description='Upload only the 14 main UPP Markdown/PDF files.')
    parser.add_argument('--folder-id', default=FOLDER_ID, help='Destination Google Drive folder ID (default: Upravljanje poslovnim procesima)')
    ...
    parser.add_argument('--script', choices=SCRIPTS, help='Select one lesson (default: all 7)')
